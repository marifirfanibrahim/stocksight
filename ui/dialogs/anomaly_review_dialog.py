...
class AnomalyReviewDialog(QDialog):
    ...
    def _setup_ui(self) -> None:
        ...
        self._details_frame.setMaximumHeight(80)
        ...
        details_layout.addWidget(self._view_btn)
    ...
    def _populate_table(self) -> None:
        ...
        for i, anomaly in enumerate(self._anomalies):
            ...
            if anomaly.severity >= 0.7:
                severity_item.setBackground(QBrush(QColor(255, 200, 200)))
            elif anomaly.severity >= 0.4:
                severity_item.setBackground(QBrush(QColor(255, 255, 200)))
            else:
                severity_item.setBackground(QBrush(QColor(200, 255, 200)))
    ...
    def _show_details(self, anomaly: Anomaly) -> None:
        ...
        details = (
            f"<b>Item:</b> {anomaly.sku} | "
            f"<b>Date:</b> {anomaly.date} | "
            f"<b>Difference:</b> {diff:+,.0f} ({diff_pct:+.1f}%) | "
    ...
    def _update_summary(self) -> None:
        ...
        self._summary_label.setText(
            f"Showing {visible} of {total} anomalies | {actioned} actions pending"
        )
